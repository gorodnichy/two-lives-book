...
description: "«Two Lives» by Concordia Antarova: translation and analysis by Dmitry Gorodnichy"
...
This work
presents the English translation and text analysis of 
the "The Lives" book by [Concordia  Antarova](https://en.wikipedia.org/wiki/Concordia_Antarova). 
While widely known in Russian speaking spheres, and   [translated into French](http://www.editions3m.com/livre.php?ID=23), this is book remains largely unknown to English speaking population, despite its signifincant spritual importance.


While the efforts on translating this book into English continue,  here we present 
the semantic and emotional analysis of the text, performed using   text mining data science tools.

The first Part of the book is used, the working draft translation of which is provided. 

Other largely unknown to English public Russian texts of large spiritual significance include those  of [Nicholas Roerich](Nicholas Roerich) and [Helena Blavatsky](https://en.wikipedia.org/wiki/Helena_Blavatsky). The translations and analysis of these texts is in progress.
...
This work is done in support of the  www.BookTwoLives.com project. The project respects the intellectual property rights of all content creators. 
